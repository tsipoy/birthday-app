...
parcelRequire = (function (modules, cache, entry, globalName) {
      ...
      function (require, module, exports) {
          ...
          const populateBirthday = (people) => {
            ...
            return sortedPeople
              .map((person) => {
                ...
                let diff = Math.ceil(
                  (birth.getTime() - today.getTime()) / oneDay
                );

                if (diff == "0") {
                  let daysLeftElement =
                    document.getElementsByClassName("leftDay");
        ...
        `
          ...
          const editPopup = (editId) => {
            ...
            return new Promise(async function (resolve) {
              const date = new Date(editIdPopup.birthday)
                .toISOString()
                .slice(0, 10);
              const formatDate = new Date().toISOString().slice(0, 10);
        ...
        `
              ...
              openDiv.addEventListener("click", (e) => {
                ...
                const cancelDelete = e.target.closest(
                ...
                if (deleteConfirm) {
                  ...
                  birthdayData.dispatchEvent(
                    new CustomEvent("updatedBirthday")
                  );
                  updateLocalStorage();
                  document.body.style.overflow = "auto";
                }
  ...
  {},
  ["node_modules/parcel-bundler/src/builtins/hmr-runtime.js", "script.js"],
  null
);
